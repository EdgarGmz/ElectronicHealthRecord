...
import type { updateNursingConsultationSchema, UpdateNursingConsultationInput } from '@/types/nursing-consultation.update.schema';
import type { NursingConsultation } from '@/types/nursing-procedure';
