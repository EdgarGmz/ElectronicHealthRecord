...
- Gestión de expedientes médicos de estudiantes.
- Administración de medicamentos.
- Gestión de citas para enfermería y psicología.
- Generación de reportes de salud.

## Integrantes del equipo

- Edgar Gómez
- [Agregar nombres de los demás integrantes aquí]

## Stack Tecnológico (sujeto a cambios)

- **Frontend:** React.js con Electron
